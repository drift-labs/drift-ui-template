import{e as ce}from"./chunk-6TIAWJQS.js";import{a as E,c as z,d as K,e as H,f as _}from"./chunk-2ZIJEOTL.js";import{a as h}from"./chunk-7JKUY6KU.js";import{a as pe,b as V}from"./chunk-HO6FHTKM.js";import{lc as de,mc as le}from"./chunk-ZYPI3ESJ.js";import{a as M}from"./chunk-5OF7XKWY.js";import{db as x,m as a,u as W}from"./chunk-FVUSQHVT.js";import{c as ae}from"./chunk-25TPEQ2Q.js";import{h as se}from"./chunk-HTY647YJ.js";import{Bd as Z,Ic as J,Me as N,Pe as te,Qf as U,Se as oe,Zd as R,_e as re,ce as ee,dg as ie,mc as Q,sd as Y,tf as ne,va as G,xb as A}from"./chunk-E2A6YDRV.js";import{Ga as v,I as X,J as q,X as g,c as C,gb as b,ya as L}from"./chunk-BEUYJGED.js";import{f as I,h as p,n as c}from"./chunk-64CIGK2X.js";p();c();var n=I(C());p();c();var r=I(C());var ue=({onChange:e,value:t,networkID:o})=>{let d=N(),i=(0,r.useMemo)(()=>{if(!o)return[];let f=A.getAddressTypes(o);return d.filter(l=>f.includes(l))},[d,o]);if(!i||i.length===0)return null;let m=i.includes(t)?t:i[0];return r.default.createElement(Ce,{onChange:e,value:m},({isExpanded:f})=>r.default.createElement(r.default.Fragment,null,r.default.createElement(ve,{isActive:f},r.default.createElement(me,{networkID:o,addressType:m},r.default.createElement(fe,null,r.default.createElement(W,{fill:L.colors.legacy.textDiminished,width:10})))),r.default.createElement(be,{portal:!1},r.default.createElement(H,{maxHeight:"300px"},i?.filter(l=>l!==m)?.map(l=>r.default.createElement(Te,{key:l,value:l},r.default.createElement(me,{networkID:o,addressType:l})))))))},me=({addressType:e,networkID:t,children:o})=>!t||!e?null:r.default.createElement(h,{justify:"space-between"},r.default.createElement(h,null,r.default.createElement(M,{networkID:t,size:32}),r.default.createElement(ke,null,G.getDisplayName(e))),o),Ce=a(E)`
  width: 100%;
  position: relative;
`,fe=a.div`
  display: inline-flex;
...
//# sourceMappingURL=chunk-IUZYCVWN.js.map
